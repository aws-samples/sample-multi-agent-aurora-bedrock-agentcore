...
This document is provided for the Public Content Security Review (PCSR) of
the sample multi-agent application in this repository. It is **not** a
deployment guide.
...
- Authorization policies (Cedar) — Module 06 of the workshop, intentionally
  excluded from this sample so the repo stays in PCSR scope (per the SMGS
  Security-Impacting Changes escalation clause, content providing guidance
  on implementing authorization would require AppSec review)
...
- [SMGS Public Content Security Review](https://console.harmony.a2z.com/engsec-docs/SA/SMGS-security-reviews/public-content-security-reviews)
